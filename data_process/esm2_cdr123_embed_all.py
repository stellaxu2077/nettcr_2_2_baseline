...
#data_filename = "train20_index.csv"
...
data.to_pickle(path=f'../data/esm2_cdr123_embedding_full.pkl')

#print(f"Embedding completed, results saved as './s01_et{embedder_index_tcr}_embedding.pkl'")
print(f"Embedding completed, results saved as '../data/esm2_cdr123_embedding_full.pkl'")
